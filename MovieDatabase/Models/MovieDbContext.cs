    ...
    class MovieDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Actor>()
                ...
                .IsRequired();
            modelBuilder.Entity<Actor>()
                .Property(fname => fname.FirstName)
                .HasMaxLength(20);
            modelBuilder.Entity<Actor>()
                .Property(lname => lname.LastName)
                .HasMaxLength(20);
            modelBuilder.Entity<Actor>()
                .Property(gender => gender.Gender)
                .HasMaxLength(1);
            modelBuilder.Entity<Actor>()
                .HasMany(actor => actor.MovieCasts)
            ...
            modelBuilder.Entity<Movie>()
                ...
                .HasMaxLength(5);
            modelBuilder.Entity<Movie>()
                .HasMany(movie => movie.MovieCasts)
                .WithOne(moviecast => moviecast.Movie);
            modelBuilder.Entity<Movie>()
                .HasMany(movie => movie.MovieDirections)
            ...
            modelBuilder.Entity<Director>()
                ...
                .HasMaxLength(20);
            modelBuilder.Entity<Director>()
                .HasMany(director => director.MovieDirections)
            ...
            modelBuilder.Entity<Reviewer>()
                ...
                .HasMaxLength(30);
            modelBuilder.Entity<Reviewer>()
                .HasMany(reviewer => reviewer.Ratings)
            ...
            modelBuilder.Entity<MovieCast>()
                ...
                .HasMaxLength(30);
            modelBuilder.Entity<MovieCast>()
                .HasKey(mc => new { mc.ActorId, mc.MovieId });
